...
function Footer() {
    ...
    <div className="bg-footer-bg text-main-text p-5 space-y-4 mt-10 text-xl">
      ...
      <address>
        ...
        <ul className="space-y-2 not-italic">
          ...
          <li className="flex items-center gap-2">
            <img src={PhoneLogo} alt="Телефон" className="w-10 h-10" />
            <a href="tel:+375292718888">+375 (29) 271 88 88</a>
          </li>

          <li className="flex items-center gap-2">
            <img src={GeoLogo} alt="Адрес" className="w-10 h-10" />
