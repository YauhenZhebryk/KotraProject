...
function HeaderComponent() {
	return (
		<>
			<header className='sticky top-0 z-50 w-full flex flex-col items-center bg-main-bg lg:flex-row lg:px-52'>
				<Link to="/">
					<img src={kotraLogo} alt="" className='h-32 m-auto mt-2 lg:w-80 lg:h-full' />
				</Link>
